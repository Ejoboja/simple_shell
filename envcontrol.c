...
/**
* _initialize_env - Initialize a new environment variable or modify an existing one
* @info: Structure containing potential arguments
* Return: Always 0
*/
int _initialize_env(info_t *info)
{
	if (info->argc != 3)
	{
...
/**
* populate_environment - populates the environment linked list
* @info: Structure containing potential arguments
* Return: Always 0
*/
int populate_environment(info_t *info)
{
	list_t *node = NULL;
	size_t i;
